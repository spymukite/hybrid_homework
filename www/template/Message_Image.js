function loadImageMessage(id, type, time, imageData, homeworkTargetDate)
{
    var append_string = '';
    if (type == "Student")
    {
    ...
    append_string += '<p><img class="painted_image" src="' + imageData + '"></p>';
    append_string += '<p>&nbsp;</p>';
    ...
    if (type == "Teacher")
    {
        ...
        append_string += '<span class="edit_bttn ClickToEditHomeworkMessage" type="image">';
